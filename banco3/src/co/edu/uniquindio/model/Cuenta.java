...
public class Cuenta {
	...
	public boolean obtenerDocumentoTitular(String documento){
		boolean comparacion = clienteTitular.getDocumento().equals(documento);
		return comparacion;
	}

	@Override
	public String toString() {
		return "Cuenta [saldo=" + saldo + ", numero=" + numero + ", clienteTitular=" + clienteTitular + ", tipo=" + tipo
				+ "]";
	}
